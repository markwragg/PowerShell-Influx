Function Send-3ParSystemMetrics {
    <#
        ...
        .EXAMPLE
            Send-3ParSystemMetrics -Measure 'Test3PAR' -Tags System_Name,System_Model,System_ID -SANIPAddress 1.2.3.4 -SANUsername admin -SANPasswordFile C:\scripts\3par.pwd
